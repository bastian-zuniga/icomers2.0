package com.icomer.workspace.service; // <-- Paquete actualizado

import com.icomer.workspace.model.Ventas; // <-- Import actualizado
import com.icomer.workspace.repository.VentasRepository; // <-- Import actualizado
